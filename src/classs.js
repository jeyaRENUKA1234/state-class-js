...
return (
<div>
<button onClick={() => this.ascending()}>Ascendingname</button>
<button onClick={() => this.descending()}>Descendingname</button>
<button onClick={() => this.ascPrice()}>AscendingPricecount</button>
<button onClick={() => this.dscPrice()}>DescendingPricecount</button>
<button onClick={() => this.purchase()}>filtertrue</button>
